...
public class NewsActivity extends AppCompatActivity implements SelectListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setTitle("Procurando novos artigos..");
        dialog.show();
    ...
    private final OnFetchDataListener<NewsApiResponse> listener = new OnFetchDataListener<NewsApiResponse>() {
        ...
        public void onFetchData(List<NewsHeadlines> list, String message) {
            if (list.isEmpty()){
                Toast.makeText(NewsActivity.this, "Ops! Não encontramos nada!!", Toast.LENGTH_SHORT).show();
            }
            else {
                showNews(list);
            }
        ...
        @Override
        public void onError(String messenge) {
            Toast.makeText(NewsActivity.this, "Aconteceu um probleminha!", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public void onClick(View view) {
        ...
        dialog.setTitle("Procurando novos artigos de "+category);
        dialog.show();
        RequestManager manager = new RequestManager(this);
